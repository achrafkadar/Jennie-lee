...
export type MouseSpotlightProps = {
  className?: string;
  size?: number;
...
/**
 * Spotlight qui suit la souris (style ibelick / Aceternity).
 * À placer en enfant direct d’un conteneur `relative` (ex. une Card).
 */
export function MouseSpotlight({
  ...
  }, [parentElement, handleMouseMove, onEnter, onLeave]);
